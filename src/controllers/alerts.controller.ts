...
// Get alerts for a specific tracker by trackerId for the authenticated user
export const getAlertsById = async (req: Request, res: Response) => {
  try {
    const userId = req.user?.id;
...
// Get all alerts for a specific tracker by trackerId for the authenticated user
export const getAlertsByTrackerId = async (req: Request, res: Response) => {
  try {
    const userId = req.user?.id;
    const { trackerId } = req.params;
